...
import { useAuth } from "@/lib/hooks/use-auth"; // Added missing import
import {
  // Removed unused AreaChart, Area, XAxis, YAxis, CartesianGrid
  Tooltip,
  ResponsiveContainer,
  PieChart,
  Pie,
...
export default function AdminDashboardPage() {
  ...
  const [cleanupDays, setCleanupDays] = useState(30); // Fixed missing const
  const { user } = useAuth(); // Moved hook to top level, before any conditional returns
