...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={`flex h-10 w-full items-center justify-between rounded-md border border-[#2a2a2a] bg-[#1a1a1a] px-3 py-2 text-sm text-[#f5f0e8] ring-offset-[#0d0d0d] placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-[#f5c842] disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 ${className || ""}`}
    {...props}
  >
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={`relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-[#f5c842] focus:text-[#0d0d0d] data-disabled:pointer-events-none data-disabled:opacity-50 ${className || ""}`}
    {...props}
  >
